...
// 因为swift协议注册时机问题，swift语言下 MBService 注册/发现尚未实现

//public extension MBService {
//
...
//
//
//    func service<Service>(of serviceType: Service.Type, from context:MBContextProtocol?) ->Service? {
