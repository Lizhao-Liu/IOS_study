...
public extension UIColor {
    ...
    /// SwifterSwift: RGB components for a UIColor (between 0 and 255).
    ///
    ...
    // swiftlint:disable large_tuple
    /// SwifterSwift: RGB components for a UIColor represented as CGFloat numbers (between 0 and 1).
    ///
    ...
    /// SwifterSwift: Get UInt representation of a UIColor (read-only).
    var uInt: UInt {
        let components: [CGFloat] = {
            let comps: [CGFloat] = cgColor.components!
            guard comps.count != 4 else { return comps }
...
public extension UIColor {
    ...
    ///
    /// - Parameters:
    ///   - color1: first UIColor to blend
    ///   - intensity1: intensity of first UIColor (default is 0.5)
    ///   - color2: second UIColor to blend
    ///   - intensity2: intensity of second UIColor (default is 0.5)
    /// - Returns: UIColor created by blending first and second colors.
    ...
    /// SwifterSwift: Lighten a UIColor.
    ///
    ///     let UIColor = UIColor(red: r, green: g, blue: b, alpha: a)
    ///     let lighterColor: UIColor = UIColor.lighten(by: 0.2)
    ///
    /// - Parameter percentage: Percentage by which to lighten the UIColor.
    /// - Returns: A lightened UIColor.
    func lighten(by percentage: CGFloat = 0.2) -> UIColor {
        // https://stackoverflow.com/questions/38435308/swift-get-lighter-and-darker-UIColor-variations-for-a-given-uicolor
    ...
    /// SwifterSwift: Darken a UIColor.
    ///
    ///     let UIColor = UIColor(red: r, green: g, blue: b, alpha: a)
    ///     let darkerColor: UIColor = UIColor.darken(by: 0.2)
    ///
    /// - Parameter percentage: Percentage by which to darken the UIColor.
    /// - Returns: A darkened UIColor.
...
public extension UIColor {
    ...
    /// SwifterSwift: Create UIColor from hexadecimal string in the format ARGB (alpha-red-green-blue).
    ///
    /// - Parameters:
...
public extension UIColor {
    /// SwifterSwift: Brand identity UIColor of popular social media platform.
    enum Social {
        ...
        public static let whatsApp = UIColor(red: 37, green: 211, blue: 102)!
    }
}
...
public extension UIColor {
    ...
    enum Material {
        // https://material.google.com/style/UIColor.html

        /// SwifterSwift: UIColor red500
        ...
        /// SwifterSwift: UIColor purple500
        ...
        /// SwifterSwift: UIColor deepPurple500
        ...
        /// SwifterSwift: UIColor indigo500
        ...
        /// SwifterSwift: UIColor lightBlue500
        ...
        /// SwifterSwift: UIColor lightGreen500
        ...
        /// SwifterSwift: UIColor yellow500
        ...
        /// SwifterSwift: UIColor orange500
        ...
        /// SwifterSwift: UIColor deepOrange500
        ...
        /// SwifterSwift: UIColor blueGrey500
