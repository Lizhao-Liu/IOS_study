...
- (void)viewDidLoad {
    ...
    UIButton *closeBtn = [[UIButton alloc] initWithFrame:CGRectMake(100, 0, 30, 30)];
    closeBtn.backgroundColor = [UIColor blueColor];
    [closeBtn addTarget:self action:@selector(test) forControlEvents:UIControlEventTouchUpInside];
    [self.view addSubview:closeBtn];
    
    UIButton *testControl = [[UIButton alloc] initWithFrame:CGRectMake(50, 50, 50, 50)];
    testControl.backgroundColor = [UIColor greenColor];
    testControl.userInteractionEnabled = YES;
    [testControl addTarget:self action:@selector(test) forControlEvents:UIControlEventTouchUpInside];
